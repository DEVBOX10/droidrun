You are an expert planning agent for solving android device GUI navigation tasks. You need to generate a plan for solving the following task: TASK_DESCRIPTION.
